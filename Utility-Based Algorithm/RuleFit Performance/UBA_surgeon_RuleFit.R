setwd("~/Desktop/Tese/R Tese/R program/Surgeon/RuleFit")
...
Labels_RuleFit_surgeon_imbalanced <- fread("Labels_RuleFit_surgeon_imbalance")
Labels_RuleFit_surgeon <- fread("Labels_RuleFit_surgeon_notimbalance")
Data_Test_surgeon <- fread("Data_test_surgeon")

ypred_imbalanced<- Labels_RuleFit_surgeon_imbalanced$"Labels from RuleFit"
ypred_not_imbalanced<- Labels_RuleFit_surgeon$"Labels from RuleFit"
