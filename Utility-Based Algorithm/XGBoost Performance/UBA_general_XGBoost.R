setwd("~/Desktop/Tese/R Tese/R program/General/XGBoost")
...
Labels_XGBoost_general_imbalanced <- fread("Labels_XGBoost_imbalanced")
Labels_XGBoost_general <- fread("Labels_XGBoost_not_imbalanced")
Data_Test_general <- fread("Data_test")

ypred_imbalanced<- Labels_XGBoost_general_imbalanced$"Labels from XGBoost"
ypred_not_imbalanced<- Labels_XGBoost_general$"Labels from XGBoost"
