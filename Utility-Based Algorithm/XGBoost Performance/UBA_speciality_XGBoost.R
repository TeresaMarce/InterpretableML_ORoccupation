setwd("~/Desktop/Tese/R Tese/R program/Speciality/XGBoost")
...
Labels_XGBoost_speciality_imbalanced <- fread("Labels_XGBoost_speciality_imbalanced")
Labels_XGBoost_speciality <- fread("Labels_XGBoost_speciality_not_imbalanced")
Data_Test_speciality <- fread("Data_test_speciality")

ypred_imbalanced<- Labels_XGBoost_speciality_imbalanced$"Labels from XGBoost"
ypred_not_imbalanced<- Labels_XGBoost_speciality$"Labels from XGBoost"
